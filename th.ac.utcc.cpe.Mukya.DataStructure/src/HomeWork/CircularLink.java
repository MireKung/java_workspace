...
/**
/*
 @author Mukya_Wongdaraphanich 5907101012  ยังไม่เสร็จดีคิดไม่ออกแล้วว
*/
import java.util.*;
public class CircularLink {
	...
	public boolean isEmthy(){
	 ...
	 public int getSize(){
	    ...
	    public void insertAtStart(int val){ //อันนี้ถึงจะก๊อปมาแต่เข้าใจนะ
	    ...
	    public void deleteAtPos(int pos){    //ก๊อปมาครับยอมรับแต่พอเข้าใจการทำงานนะ
	    ...
	    public void display() //อันนี้ก๊อปมาแก้นิดหน่อยให้มันเข้ากับโจทย์
	    {
